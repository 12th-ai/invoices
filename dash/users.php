  ...
  <main>
    ...
    <div class="main">
      <?php 
        ...
        if(isset($_GET['del'])) {
          $delId = $_GET['del'];
          $del = mysqli_query($conn, "DELETE FROM users WHERE user_id = '$delId'");
          if($del) {
            echo '<script>
              Swal.fire({
      ...
      <div class="main-data">
        <div class="data-table">
          <h1 class="title">
            All Users (<?php echo mysqli_num_rows($get); ?>)
          ...
          <table>
            ...
            <?php 
              ...
              while($fetch = mysqli_fetch_array($get)){
                if($fetch['user_level'] == 1) {
                  $title = 'Receptionist';
                } else if($fetch['user_level'] == 2) {
                  $title = 'Buyer';
                } else if($fetch['user_level'] == 3) {
            ...
            <tr>
              ...
              ?>
              <td>
                <a href="./users_update.php?upId=<?php echo $fetch['user_id'];?>">Update</a>
                <button onclick="deleteRecord(<?php echo $fetch['user_id']; ?>)">Delete</button>
              </td>
              <?php } else { ?>
                <td>-</td>
              <?php } ?>
